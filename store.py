...
# Export only the Store class at module level
__all__ = ['Store']

# Hide auxiliary functions, internal members, and behaviour __init__ methods from pdoc sidebar
__pdoc__ = {
    # Hide auxiliary functions
    'Store.calculate_warehouse_score': False,
    'Store.dict_to_order': False,
    'Store.message_to_order': False,
    'Store.set_buy_metadata': False,
    'Store.update_graph': False,
    'Store.get_stats': False,
    'Store.print_stock': False,
    # Hide internal class variables
    'Store.id_counter': False,
    'Store.id': False,
    'Store.graph': False,
    'Store.stock': False,
    'Store.warehouses': False,
    'Store.products_to_buy': False,
    'Store.orders': False,
    'Store.orders_lock': False,
    'Store.vehicles_in_transit': False,
    'Store.total_cost': False,
    'Store.total_time': False,
    'Store.retry_queue': False,
    'Store.retry_lock': False,
    'Store.stats': False,
    'Store.csv_file': False,
    'Store.csv_writer': False,
    'Store.world_agent': False,
    # Hide behaviour __init__ methods (show only run)
    'Store.BuyProduct.__init__': False,
    'Store.CollectWarehouseResponses.__init__': False,
    'Store.ReceiveAllResponses.__init__': False,
    'Store.SendStoreConfirmation.__init__': False,
    'Store.SendStoreDenial.__init__': False,
    'Store.RetryPreviousBuy.__init__': False,
    'Store.ReceiveTimeDelta.__init__': False,
    'Store.ReceiveVehicleArrival.__init__': False,
    # Hide behaviour instance variables
    'Store.BuyProduct.quantity': False,
    'Store.BuyProduct.product': False,
    'Store.CollectWarehouseResponses.request_id': False,
    'Store.CollectWarehouseResponses.buy_msg': False,
    'Store.CollectWarehouseResponses.num_warehouses': False,
    'Store.CollectWarehouseResponses.quantity': False,
    'Store.CollectWarehouseResponses.product': False,
    'Store.CollectWarehouseResponses.acceptances': False,
    'Store.CollectWarehouseResponses.rejections': False,
    'Store.ReceiveAllResponses.request_id': False,
    'Store.ReceiveAllResponses.num_warehouses': False,
    'Store.ReceiveAllResponses.acceptances': False,
    'Store.ReceiveAllResponses.rejections': False,
    'Store.ReceiveAllResponses.responses_received': False,
    'Store.ReceiveAllResponses.timeout': False,
    'Store.SendStoreConfirmation.dest': False,
    'Store.SendStoreConfirmation.request_id': False,
    'Store.SendStoreDenial.dest': False,
    'Store.SendStoreDenial.request_id': False,
    'Store.RetryPreviousBuy.quantity': False,
    'Store.RetryPreviousBuy.product': False,
    'Store.ReceiveTimeDelta.order_id': False,
    'Store.ReceiveTimeDelta.time_delta': False,
    'Store.ReceiveVehicleArrival.order_id': False,
}
