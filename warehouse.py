...
# Export only the Warehouse class at module level
__all__ = ['Warehouse']

# Hide auxiliary functions, internal members, and behaviour __init__ methods from pdoc sidebar
__pdoc__ = {
    # Hide auxiliary functions
    'Warehouse.calculate_supplier_score': False,
    'Warehouse.message_to_order': False,
    'Warehouse.set_buy_metadata': False,
    'Warehouse.update_graph': False,
    'Warehouse.print_stock': False,
    'Warehouse.dict_to_order': False,
    # Hide internal class variables
    'Warehouse.id_counter': False,
    'Warehouse.id': False,
    'Warehouse.graph': False,
    'Warehouse.stock': False,
    'Warehouse.stores': False,
    'Warehouse.suppliers': False,
    'Warehouse.orders': False,
    'Warehouse.orders_lock': False,
    'Warehouse.vehicles': False,
    'Warehouse.available_vehicles': False,
    'Warehouse.vehicles_lock': False,
    'Warehouse.vehicles_in_transit': False,
    'Warehouse.total_cost': False,
    'Warehouse.total_time': False,
    'Warehouse.world_agent': False,
    # Hide behaviour __init__ methods (show only run)
    'Warehouse.ReceiveBuyRequest.__init__': False,
    'Warehouse.AcceptBuyRequest.__init__': False,
    'Warehouse.RejectBuyRequest.__init__': False,
    'Warehouse.ReceiveConfirmationOrDenial.__init__': False,
    'Warehouse.AssignVehicle.__init__': False,
    'Warehouse.ReceivePresenceInfo.__init__': False,
    'Warehouse.ReceiveVehicleProposals.__init__': False,
    'Warehouse.ChooseBestVehicle.__init__': False,
    'Warehouse.BuyMaterial.__init__': False,
    'Warehouse.CollectSupplierResponses.__init__': False,
    'Warehouse.ReceiveAllSupplierResponses.__init__': False,
    'Warehouse.SendWarehouseConfirmation.__init__': False,
    'Warehouse.SendWarehouseDenial.__init__': False,
    'Warehouse.RetryPreviousBuy.__init__': False,
    'Warehouse.HandleResupply.__init__': False,
    'Warehouse.ReceiveVehicleArrival.__init__': False,
    'Warehouse.ReceiveTimeDelta.__init__': False,
    # Hide behaviour instance variables (Store interaction)
    'Warehouse.ReceiveBuyRequest.request_id': False,
    'Warehouse.ReceiveBuyRequest.store_jid': False,
    'Warehouse.AcceptBuyRequest.dest': False,
    'Warehouse.AcceptBuyRequest.request_id': False,
    'Warehouse.AcceptBuyRequest.quantity': False,
    'Warehouse.AcceptBuyRequest.product': False,
    'Warehouse.AcceptBuyRequest.price': False,
    'Warehouse.AcceptBuyRequest.arrival_time': False,
    'Warehouse.RejectBuyRequest.dest': False,
    'Warehouse.RejectBuyRequest.request_id': False,
    'Warehouse.ReceiveConfirmationOrDenial.request_id': False,
    'Warehouse.ReceiveConfirmationOrDenial.store_jid': False,
    # Hide behaviour instance variables (Supplier interaction)
    'Warehouse.BuyMaterial.quantity': False,
    'Warehouse.BuyMaterial.product': False,
    'Warehouse.CollectSupplierResponses.request_id': False,
    'Warehouse.CollectSupplierResponses.buy_msg': False,
    'Warehouse.CollectSupplierResponses.num_suppliers': False,
    'Warehouse.CollectSupplierResponses.quantity': False,
    'Warehouse.CollectSupplierResponses.product': False,
    'Warehouse.CollectSupplierResponses.acceptances': False,
    'Warehouse.CollectSupplierResponses.rejections': False,
    'Warehouse.ReceiveAllSupplierResponses.request_id': False,
    'Warehouse.ReceiveAllSupplierResponses.num_suppliers': False,
    'Warehouse.ReceiveAllSupplierResponses.acceptances': False,
    'Warehouse.ReceiveAllSupplierResponses.rejections': False,
    'Warehouse.ReceiveAllSupplierResponses.responses_received': False,
    'Warehouse.ReceiveAllSupplierResponses.timeout': False,
    'Warehouse.SendWarehouseConfirmation.dest': False,
    'Warehouse.SendWarehouseConfirmation.request_id': False,
    'Warehouse.SendWarehouseDenial.dest': False,
    'Warehouse.SendWarehouseDenial.request_id': False,
    # Hide behaviour instance variables (Vehicle coordination)
    'Warehouse.ReceiveTimeDelta.order_id': False,
    'Warehouse.ReceiveTimeDelta.time_delta': False,
    'Warehouse.ReceiveVehicleArrival.order_id': False,
}
